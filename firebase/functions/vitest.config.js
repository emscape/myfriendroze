...
module.exports = defineConfig({
  ...
  test: {
    coverage: {
      provider: 'v8',
      include: ['lib/**', 'createCheckoutSession.js', 'stripeWebhook.js', 'orderConfirmation.js', 'unsubscribe.js', 'eventNotification.js', 'newsletterSignup.js', 'confirmNewsletterSignup.js', 'orderShipped.js'],
      thresholds: {
        lines: 85,
        functions: 85,
        branches: 85,
